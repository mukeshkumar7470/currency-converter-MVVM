package com.mukesh.currency.ui.viewmodels
...
import com.mukesh.currency.usecases.CurrencyUseCases
...
/**
 * view model class used by [com.mukesh.currency.ui.CurrenciesFragment]
 */
@HiltViewModel
class CurrenciesViewModel @Inject internal constructor(private val useCase: CurrencyUseCases) :
     ...
     * error case is handled using custom exceptions. Take a look at [com.mukesh.currency.data.exceptions.NetworkException]
     * and [com.mukesh.currency.data.exceptions.GenericException]
     */
